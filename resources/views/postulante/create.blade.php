@extends('layouts.main', ['activePage' =>'postulantes', 'titlePage' =>'Nuevo Postulante'])
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{route('postulante.store')}}" method="post" class="form-horizontal">
                        @csrf
                        <div class="card">
